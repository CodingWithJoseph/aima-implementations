...
from src.ch2.agent.vacuum_agents import sra_vacuum_actions_2squares_1d, sra_vacuum_interpret_input, vacuum_world_evaluation
...
sra_vacuum_agent = SimpleReflexAgent(sra_vacuum_actions_2squares_1d, sra_vacuum_interpret_input)
